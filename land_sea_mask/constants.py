...
LSM_128x64x15_Z_LEFT = (0, 50, 120, 220, 360, 550, 790, 1080, 1420, 1810, 2250, 2740, 3280, 3870, 4510)
LSM_128x64x15_Z_CENTER = (np.array(LSM_128x64x15_Z_LEFT[1:] + (9000,)) + np.array(LSM_128x64x15_Z_LEFT)) / 2
# LSM_128x64x15_Z_RIGHT = [50, 120, 220, 360, 550, 790, 1080, 1420, 1810, 2250, 2740, 3280, 3870, 4510, 5200]