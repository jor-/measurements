...
def histogram_and_density_function(measurements_object, file=None, min_number_of_values=50, histogram_step_size=0.05, type='measurement_results', overwrite=False, **kwargs):
    # check input
