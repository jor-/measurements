...
MEAN_FILE = os.path.join(MEAN_DIR,
'concentration_mean_-_for_{target}_-_sample_{sample_lsm}_-_min_measurements_{min_measurements:d}_-_fill_{fill_strategy}.npy')
...
DEVIATION_FILE = os.path.join(DEVIATION_DIR,
'{deviation_type}_-_for_{target}_-_sample_{sample_lsm}_-_min_measurements_{min_measurements:d}_-_min_deviation_{min_standard_deviation:g}_-_fill_{fill_strategy}.npy')
...
'map_indices_to_point_index_dict_-_sample_{sample_lsm}_-_year_discarded_{discard_year}.ppy')

CONCENTRATIONS_SAME_POINTS_EXCEPT_YEAR_DICT_FILE = os.path.join(CORRELATION_DIR,
'concentrations_same_points_except_year_dict_-_sample_{sample_lsm}_-_min_values_{min_measurements_correlation:0>2d}.ppy')

SAMPLE_COVARIANCE_DICT_FILE = os.path.join(CORRELATION_DIR,
'sample_covariance_dict.nonstationary_-_sample_{sample_lsm}_-_min_values_{min_measurements_correlation:0>2d}_-_max_year_diff_{max_year_diff:0>2}.ppy')
...
'sample_correlation.same_box.lower_triangle_-_sample_{sample_lsm}_-_min_abs_{min_abs_correlation}_-_deviation_{standard_deviation_description}_-_{dtype}.{matrix_format}.npz')

SAMPLE_QUANTITY_MATRIX_DIFFERENT_BOXES_LOWER_TRIANGLE_MATRIX_FILE = os.path.join(CORRELATION_DIR,
'sample_quantity.different_boxes.lower_triangle_-_sample_{sample_lsm}_-_min_values_{min_measurements_correlation:0>2d}_-_max_year_diff_{max_year_diff:0>2}_-_min_abs_{min_abs_correlation}_-_deviation_{standard_deviation_description}_-_{dtype}.{matrix_format}.npz')

SAMPLE_CORRELATION_MATRIX_DIFFERENT_BOXES_LOWER_TRIANGLE_MATRIX_FILE = os.path.join(CORRELATION_DIR,
'sample_correlation.different_boxes.lower_triangle_-_sample_{sample_lsm}_-_min_values_{min_measurements_correlation:0>2d}_-_max_year_diff_{max_year_diff:0>2}_-_min_abs_{min_abs_correlation}_-_deviation_{standard_deviation_description}_-_{dtype}.{matrix_format}.npz')

SAMPLE_CORRELATION_MATRIX_FILE = os.path.join(CORRELATION_DIR,
'sample_correlation_-_sample_{sample_lsm}_-_min_values_{min_measurements_correlation:0>2d}_-_min_abs_{min_abs_correlation}_-_max_abs_{max_abs_correlation}_-_deviation_{standard_deviation_description}_-_{dtype}.{matrix_format}.npz')
...
'correlation.positive.reduction_factors_-_sample_{sample_lsm}_-_min_values_{min_measurements_correlation:0>2d}_-_min_abs_{min_abs_correlation}_-_max_abs_{max_abs_correlation}_-_{ordering_method}_ordering.reordering_{reordering}_-_min_diag_{cholesky_min_diag_value:.0e}_-_deviation_{standard_deviation_description}.npy')

CORRELATION_MATRIX_CHOLESKY_FACTOR_FILE = os.path.join(CORRELATION_DIR,
'correlation.positive.cholesky_{factor_type}_-_sample_{sample_lsm}_-_min_values_{min_measurements_correlation:0>2d}_-_min_abs_{min_abs_correlation}_-_max_abs_{max_abs_correlation}_-_{ordering_method}_ordering.reordering_{reordering}_-_min_diag_{cholesky_min_diag_value:.0e}_-_deviation_{standard_deviation_description}_-_{dtype}.{matrix_format}.npz')
