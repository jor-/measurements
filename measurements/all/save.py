...
def _main():
    ...
    parser.add_argument('--concentration_quantiles_sample_lsm', action='store', type=float, help='Calculate and save the passed concentration quantile for points of sample land sea mask.')
    parser.add_argument('--average_noise_quantiles_sample_lsm', action='store', type=float, help='Calculate and save the passed average noise quantile for points of sample land sea mask.')
    ...
    with util.logging.Logger(level=args.debug_level):
        ...
        for m in m_list:
            ...
            if args.average_noise_quantiles_sample_lsm is not None:
                m.average_noise_quantiles_for_sample_lsm(args.average_noise_quantiles_sample_lsm)
