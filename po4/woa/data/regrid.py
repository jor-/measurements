...
def load_from_netcdf(netcdf_file, netcdf_dataname):
    ...
    data = util.io.load_netcdf(netcdf_file, netcdf_dataname)
...
def save():
    ...
    from ndop.model.constants import METOS_Z
    ...
    z_index_annual_threshold = bisect.bisect(METOS_Z, ANNUAL_THRESHOLD)
