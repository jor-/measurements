...
import measurements.regrid_dop
import measurements.regrid_po4
...
def po4_load_npy_or_save_regrided(npy_file, debug_level = 0, required_debug_level = 1):
    ...
    try:
        ...
        measurements.regrid_po4.save_regrided(debug_level=debug_level, required_debug_level=required_debug_level+1)
...
def po4_nobs(debug_level = 0, required_debug_level = 1):
    from measurements.constants import PO4_NOBS
...
def po4_varis(debug_level = 0, required_debug_level = 1):
    from measurements.constants import PO4_VARIS
...
def po4_means(debug_level = 0, required_debug_level = 1):
    from measurements.constants import PO4_MEANS
...
#     from measurements.constants import PO4_MOS
#     
...
def dop_load_npy_or_save_regrided(npy_file, debug_level = 0, required_debug_level = 1):
    ...
    try:
        ...
        measurements.regrid_dop.save_regrided(land_sea_mask, t_dim=12, debug_level=debug_level, required_debug_level=required_debug_level+1)
...
def dop_nobs(debug_level = 0, required_debug_level = 1):
    from measurements.constants import DOP_NOBS
...
def dop_varis(debug_level = 0, required_debug_level = 1):
    from measurements.constants import DOP_VARIS
...
def dop_means(debug_level = 0, required_debug_level = 1):
    from measurements.constants import DOP_MEANS
...
#     from measurements.constants import DOP_MOS
#     
...
def nobs(debug_level = 0, required_debug_level = 1):
    from measurements.constants import NOBS
...
def means(debug_level = 0, required_debug_level = 1):
    from measurements.constants import MEANS
...
#     from measurements.constants import MOS
#     
...
def varis(debug_level = 0, required_debug_level = 1):
    from measurements.constants import VARIS
